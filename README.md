...
This demo application was created to show how to create a new React app and how to approach the development of a new application, starting from a prototype. Feel free to reuse it and/or fork it to try and improve it or change it. [Here are the slides of the talk (in Italian).](https://slides.com/pnicolli/costruire-un-applicazione-react)

For example, problems we might want to solve here are:

- Is there a better way to implement the calculator logic?
- Is there a better way to represent the state of the application?
- Is this the best way to structure the code in the `src` folder?
- Presentational components are snapshot-tested (with jest+enzyme). Which other tests would you add? How would you test the calculator logic (the `AppContainer` component)?
...
Webpack Dev Server will take care of serving the app locally and reloading the changes in the source code on the fly.

## Create react app README
Below you can find the README generated by create-react-app, which is a great starting point to learn how to configure and develop your app.
